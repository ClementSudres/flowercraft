...
if (isset($_POST['signup'])) {
    ...
    $experience =
        mysqli_real_escape_string($db, trim($_POST['experience']));
    // validate form
    if (empty($username)) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (sizeof($errors) === 0) {
            ...
            echo "<p>You can now <a href=\"index1.html\">login</a></p>";
        }
    }
}
                        ...
                        $(document).ready(function() {
                            ...
                            $("#start").click(function() {
                                ...
                                if (player == 'player1') {
                                    $.ajax({
                                        ...
                                        success: function(html) {
                                            ...
                                            $("#one").html(print); //Insert chat log into the #chatbox div
                                        }
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(html) {
                                            ...
                                            $("#two").html(deck); //Insert chat log into the #chatbox div
                                        }
                                    });
                                } else {
                                    $.ajax({
                                ...
                                $.ajax({
                                    ...
                                    success: function(html) {
                                        let print = html.replaceAll('<br>', '');
                                        $("#position").html(print); //Insert chat log into the #chatbox div
                                    }
                                });
                                img_loaded = true;
                                hand1_loaded = true;
                                ...
                                $.ajax({
                                    ...
                                    success: function(html) {
                                        ...
                                        for (let i = 0; i < 2; i++) {
                                            ...
                                            deck = '<img src="images/carte_Autres_3.png" alt="card back" id="' + id + '">';
                                            $("#deck").prepend(deck); //Insert chat log into the #chatbox div
                                        }
